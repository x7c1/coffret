...
mod tests {
    ...
    fn derivation_matches_the_pinned_vectors() {
        ...
        assert_eq!(
            derived(Purpose::ControlActivationSnapshot),
            [
                0x7c, 0xc2, 0x9b, 0x8f, 0xf0, 0xc8, 0xa4, 0x00, 0x1e, 0xaf, 0x6a, 0x6b, 0x48, 0x60,
                0xd4, 0xcc, 0xa1, 0x1b, 0x9f, 0x01, 0xdf, 0x10, 0xbb, 0xf1, 0xc4, 0x8f, 0x90, 0x28,
                0xde, 0xce, 0x18, 0x49,
            ]
        );
        assert_eq!(
        ...
        assert_eq!(
            derived(Purpose::AccountCacheWrap),
            [
                0x7f, 0x6f, 0x32, 0x40, 0xab, 0x75, 0x88, 0x5b, 0x43, 0xb1, 0xfe, 0x30, 0x28, 0xb4,
                0xb1, 0x07, 0x11, 0xcc, 0x53, 0x90, 0x9a, 0x61, 0x36, 0x5c, 0x70, 0xe1, 0x8f, 0xbd,
                0x95, 0x15, 0x5f, 0x6a,
            ]
        );
    }
