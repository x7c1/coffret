...
- data [Containers](../container/), which hold one or more user-file Entries
...
use their Key Envelopes to open data Containers.
...
- Every Storage Object is either a data Container or a control object, never
  both.
- Data Containers have opaque names. Control objects have recognizable names
