...
describe('purpose keys', () => {
  ...
  it('spells the info strings the registry lists', () => {
    ...
    expect(PURPOSE_INFO['account-cache-wrap']).toBe('coffret/v1/account-cache-wrap');
  });
  ...
  it('derives the pinned vectors', () => {
    ...
    expect(Array.from(derived('account-cache-wrap'))).toEqual([
      0x7f, 0x6f, 0x32, 0x40, 0xab, 0x75, 0x88, 0x5b, 0x43, 0xb1, 0xfe, 0x30, 0x28, 0xb4, 0xb1,
      0x07, 0x11, 0xcc, 0x53, 0x90, 0x9a, 0x61, 0x36, 0x5c, 0x70, 0xe1, 0x8f, 0xbd, 0x95, 0x15,
      0x5f, 0x6a,
    ]);
  });
